import { EventTypes, SDK_VERSION } from '@web-watch/shared'
import { BaseClientType, BaseOptionsFieldsIntegrationType, BasePluginType, LogTypes } from '@web-watch/types'
import { logger } from '@web-watch/utils'
