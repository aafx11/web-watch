...
import { BaseOptionsFieldsIntegrationType, BaseOptionsType, VueInstance } from '@web-watch/types'
import { generateUUID, validateOptionsAndSet } from '@web-watch/utils'
