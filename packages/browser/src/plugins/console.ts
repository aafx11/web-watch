import { BrowserBreadcrumbTypes, BrowserEventTypes, globalVar } from '@web-watch/shared'
import { replaceOld, Severity, _global } from '@web-watch/utils'
import { BasePluginType, ConsoleCollectType } from '@web-watch/types'
